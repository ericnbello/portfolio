...
const url = "https://codecraftwebsolutions.us21.list-manage.com/subscribe/post?u=42e7655e73dd8d6a19ed21f5f&amp;id=7227be64b3&amp;f_id=000583e6f0";
...
const NewsletterBox = () => {
  ...
  return (
    <div className="relative z-10 p-8 bg-white dark:bg-gray-800 rounded-sm shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Subscribe for the latest updates and web development tips!
      </p>
      <div>
      <MailchimpSubscribe
          url={url}
        ...
        No spam, just useful updates and insights.
        </p>
      </div>
